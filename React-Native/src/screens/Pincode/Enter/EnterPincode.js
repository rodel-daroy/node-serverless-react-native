...
const EnterPincodeScreen = (props) => {

  const { pincode, tryChance, forgot, onWillFocus, onBack, onClickNumber, onDeleteNumber, onForgotPincode } = props;
        ...
        <View style={styles.container}>
          ...
          <View style={styles.body}>
            <View style={styles.topSection}>
              ...
              {
                forgot ?
                  <TouchableOpacity style={{ height: 30 }} onPress={onForgotPincode}>
                    <Text style={styles.forgotResult}>Forgot PIN?</Text>
                  </TouchableOpacity>
                  : tryChance > 0 && pincode.length === 0 ?
                    <View style={{ height: 30 }}>
                      <Text style={styles.tryResult}>PIN Code try again</Text>
                    </View>
                    :
                    <View style={{ height: 30 }} />
              }
